...
Rr = kP*Re
Ce = kD/Rr
print(f"El valor de la capacitanxia propuesta de Cr es de {Cr} Faradios")
...
#grafico
fg1 = plt.figure()
plt.plot(t,u1,'-',color = clr,label = 'Pao(t)')
...
fg2 = plt.figure()
plt.plot(t,u2,'-',color = clr,label = 'Pao(t)')
...
fg3 = plt.figure()
plt.plot(t,u3,'-',color = clr,label = 'Pao(t)')
...
fg4 = plt.figure()
plt.plot(t,u4,'-',color = clr,label = 'Pao(t)')
